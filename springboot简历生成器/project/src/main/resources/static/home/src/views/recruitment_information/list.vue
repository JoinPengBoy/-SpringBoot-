						...
						<div class="view Search">
							<span class="diy_list_search_title">关键字搜索：</span>
																																												<b-form-input size="sm" class="mr-sm-2" placeholder="企业名称搜索" v-model="query['enterprise_name']" />
																																																											<b-form-input size="sm" class="mr-sm-2" placeholder="注册资本搜索" v-model="query['registered_capital']" />
																																														<b-form-input size="sm" class="mr-sm-2" placeholder="岗位类型搜索" v-model="query['job_type']" />
				...
				<div class="diy_list_select_box">
					<span class="diy_list_select_title">下拉搜索：</span>
						...
						<div class="col">
							<!-- 筛选 -->
							<div class="view sift">
																					<b-dropdown text="岗位类型" variant="outline-dark" left>
									<b-dropdown-item @click="filter_set('全部','job_type')">全部</b-dropdown-item>
										<b-dropdown-item v-for="(o, i) in list_job_type" :key="i" @click="filter_set(o['job_type'],'job_type')" >
												{{ o['job_type'] }}
										</b-dropdown-item>
								</b-dropdown>
																	<!-- 排序 -->
