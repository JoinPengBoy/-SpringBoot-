		...
		<el-row class="row_ce"> 
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="用户年龄" prop="user_age">
							  ...
							  v-if="(form_sub['registered_user_id'] && $check_field('set','user_age')) || (!form_sub['registered_user_id'] && $check_field('add','user_age'))"></el-input>
				...
				<el-form-item label="联系方式" prop="contact_information">
								<el-input id="contact_information" v-model="form_sub['contact_information']" placeholder="请输入联系方式" type="tel"
						v-if="(form_sub['registered_user_id'] && $check_field('set','contact_information')) || (!form_sub['registered_user_id'] && $check_field('add','contact_information'))">
					</el-input>
					<div v-else-if="$check_field('get','contact_information')">{{form_sub['contact_information']}}</div>
							</el-form-item>
			</el-col>
				...
				<el-form-item label="教育背景" prop="educational_background">
												<el-input id="educational_background" v-model="form_sub['educational_background']" placeholder="请输入教育背景"
							  v-if="(form_sub['registered_user_id'] && $check_field('set','educational_background')) || (!form_sub['registered_user_id'] && $check_field('add','educational_background'))"></el-input>
					<div v-else-if="$check_field('get','educational_background')">{{form_sub['educational_background']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="工作经历" prop="work_experience">
												<el-input id="work_experience" v-model="form_sub['work_experience']" placeholder="请输入工作经历"
							  v-if="(form_sub['registered_user_id'] && $check_field('set','work_experience')) || (!form_sub['registered_user_id'] && $check_field('add','work_experience'))"></el-input>
					<div v-else-if="$check_field('get','work_experience')">{{form_sub['work_experience']}}</div>
											</el-form-item>
			</el-col>
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item v-if="$check_action('/registered_user/view','set') || $check_action('/registered_user/view','add') || $check_option('/registered_user/table','examine')">
	...
	export default {
		...
		methods: {
			...
			async submit_check(param){
				...
				if(form_sub.contact_information && !contact_information_phone_regular.test(form_sub.contact_information)){
					return "手机号格式错误"
				}
