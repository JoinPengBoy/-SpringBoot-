<template>
	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/recruitment_information/table','set') || $check_action('/recruitment_information/view','set') || $check_action('/recruitment_information/view','get') 
						|| $check_action('/resume_information/table','add') || $check_action('/resume_information/view','add') 
						" >
				...
				<template slot-scope="scope">
					...
					v-if="$check_action('/recruitment_information/table','set') || $check_action('/recruitment_information/view','set') || $check_action('/recruitment_information/view','get')"
						...
						<router-link v-if="$check_comment('/recruitment_information/table')" class="e-button el-button--small is-plain el-button--primary"
