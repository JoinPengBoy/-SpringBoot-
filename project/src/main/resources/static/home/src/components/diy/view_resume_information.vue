	...
	<el-main class="bg edit_wrap">
		...
		<el-row class="row_ce">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item v-if="$check_action('/resume_information/view','set') || $check_action('/resume_information/view','add')">
	...
	export default {
		...
		methods: {
			...
			async get_group_user_target_users() {
							this.form["target_users"] = this.$store.state.user.user_id;
						...
						Object.keys(form).forEach(dbKey => {
							...
							if(dbKey === "source_user_id"){
								this.form['source_user_id'] = form[dbKey];
																							        ...
																							        if (this.form["placement_time"] && JSON.stringify(this.form["placement_time"]).indexOf("-")===-1){
			...
			get_obj_after(json, func){
																																																												...
																																																												if(json.result.obj["placement_time"]=="0000-00-00 00:00:00"){
				  json.result.obj["placement_time"] = null;
				}
				if(parseInt(json.result.obj["placement_time"]) > 9999){
					json.result.obj["placement_time"] = this.$toTime(parseInt(json.result.obj["placement_time"]),"yyyy-MM-dd hh:mm:ss")
				}
