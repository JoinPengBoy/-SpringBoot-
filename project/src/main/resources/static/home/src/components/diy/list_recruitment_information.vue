	...
	<div class="diy_home diy_list diy_recruitment_information" id="diy_recruitment_information_list">
		...
		<div class="diy_view_table">
			<table class="diy_table">
				<tr class="diy_row">
							<th class="diy_title" v-if="$check_field('get','recruitment_title','/recruitment_information/list')">
					招聘标题
				</th>
										<th class="diy_title" v-if="$check_field('get','enterprise_name','/recruitment_information/list')">
					企业名称
				</th>
											<th class="diy_title" v-if="$check_field('get','registered_capital','/recruitment_information/list')">
					注册资本
				</th>
											<th class="diy_title" v-if="$check_field('get','cover_photo','/recruitment_information/list')">
					封面图片
				</th>
												</tr>
								<tr class="diy_row" v-for="(o,i) in list" :key="o+i" @click="to_detail(o)">
												<td class="diy_field diy_text" v-if="$check_field('get','recruitment_title','/recruitment_information/list')">
						<span>
							{{ o["recruitment_title"] }}
						</span>
					</td>
						...
						<span>
							{{ o["enterprise_name"] }}
												...
												<td class="diy_field diy_text" v-if="$check_field('get','registered_capital','/recruitment_information/list')">
						<span>
							{{ o["registered_capital"] }}
						</span>
					</td>
												<td class="diy_field" v-if="$check_field('get','cover_photo','/recruitment_information/list')">
