	...
	<el-main class="bg edit_wrap">
		...
		<el-row class="row_ce">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item v-if="$check_action('/interview_notice/view','set') || $check_action('/interview_notice/view','add')">
	...
	export default {
		...
		methods: {
						...
						Object.keys(form).forEach(dbKey => {
							...
							if(dbKey === "source_user_id"){
								this.form['source_user_id'] = form[dbKey];
													        ...
													        if (this.form["invitation_time"] && JSON.stringify(this.form["invitation_time"]).indexOf("-")===-1){
			...
			get_obj_after(json, func){
																																			...
																																			if(json.result.obj["invitation_time"]=="0000-00-00 00:00:00"){
				  json.result.obj["invitation_time"] = null;
				}
				if(parseInt(json.result.obj["invitation_time"]) > 9999){
					json.result.obj["invitation_time"] = this.$toTime(parseInt(json.result.obj["invitation_time"]),"yyyy-MM-dd hh:mm:ss")
				}
